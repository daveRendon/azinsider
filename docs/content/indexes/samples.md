...
This page contains various views of the module index (catalog) for **Bicep Samples**. To see these views, **click on the expandable sections** with the "➕" sign below.
...
- {{< icon "gdoc_download" >}} To download the source CSV file, click [here](/azinsider/module-indexes/BicepResourceModules.csv).
