...
resource qNodeReboots 'Microsoft.OperationalInsights/queryPacks/queries@2025-07-01' = {
  parent: qpBaselineQueryPack
...
resource paAKSLinuxRestrictive 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paEnforceHttpsIngress 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paEnforceInternalLoadBalancers 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paRoRootFilesystem 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paEnforceResourceLimits 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paEnforceImageSource 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paAllowedHostPaths 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paAllowedExternalIPs 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paDisallowEndpointEditPermissions 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paDisallowNamespaceUsage 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paDefenderInClusterEnabled 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paMicrosoftEntraIdIntegrationEnabled 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paLocalAuthDisabled 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paAzurePolicyEnabled 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paAuthorizedIpRangesDefined 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paOldKuberentesDisabled 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paRbacEnabled 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paManagedIdentitiesEnabled 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource paK8sIngressTlsHostsHaveSpecificDomainSuffix 'Microsoft.Authorization/policyAssignments@2025-11-01' = {
...
resource miClusterControlPlane 'Microsoft.ManagedIdentity/userAssignedIdentities@2024-11-30' = {
  name: 'mi-${clusterName}-controlplane'
  location: location
}

// User Managed Identity that App Gateway is assigned. Used for Azure Key Vault Access.
resource miAppGatewayFrontend 'Microsoft.ManagedIdentity/userAssignedIdentities@2024-11-30' = {
...
resource podmiIngressController 'Microsoft.ManagedIdentity/userAssignedIdentities@2024-11-30' = {
  name: 'podmi-ingress-controller'
  location: location

  // Workload identity service account federation
  resource federatedCreds 'federatedIdentityCredentials@2024-11-30' = {
...
resource mcFlux_extension 'Microsoft.KubernetesConfiguration/extensions@2024-11-01' = {
  scope: mc
  name: 'flux'
  properties: {
