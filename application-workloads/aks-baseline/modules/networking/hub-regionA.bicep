...
param nodepoolSubnetResourceIds array = [
  '/subscriptions/d988cbee-043f-4c46-9a59-dedb2119e48c/resourceGroups/rg-enterprise-networking-spokes/providers/Microsoft.Network/virtualNetworks/vnet-spoke-BU0001A0008-00/subnets/snet-clusternodes'
]
...
resource ipgNodepoolSubnet 'Microsoft.Network/ipGroups@2025-05-01' = {
...
resource hubFirewall 'Microsoft.Network/azureFirewalls@2025-05-01' = {
  name: 'fw-${location}'
  location: location
  zones: [
    '1'
